    ...
    <div className={`min-h-screen flex items-center justify-center p-4 ${
      ...
      <div className={`max-w-md w-full rounded-lg shadow-lg p-8 ${
        ...
        <div className="text-center">
          <FaExclamationTriangle className="text-5xl mb-4 text-red-600" />
          <h2 className="text-2xl font-bold mb-4 text-red-600">
            Error Loading Create Dashboard
          </h2>
          <p className={`mb-6 ${
            isDark ? 'text-gray-300' : 'text-gray-600'
          }`}>
            {error.message || "Failed to load the create dashboard. Please try again."}
          </p>
          <button
            onClick={reset}
