...
export default function CreateContactInfoError({ error, reset }: ErrorProps) {
      ...
      <div className="max-w-xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            We encountered an error while trying to create the contact information. Please try again or return to the dashboard.
          </p>
