...
export default function EditTeamMemberError({ error, reset }: ErrorProps) {
  const router = useRouter();
  
  useEffect(() => {
    // Log the error to an error reporting service
    console.error("Team member editing error:", error);
  }, [error]);
      ...
      <div className="max-w-xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            We encountered an error while managing team members. Please try again or return to the dashboard.
          </p>
