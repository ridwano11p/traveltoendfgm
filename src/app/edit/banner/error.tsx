...
export default function EditBannerError({ error, reset }: ErrorProps) {
      ...
      <div className="max-w-xl mx-auto px-4">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Error Managing Banners
          </h2>
          <p className="text-gray-600 mb-8">
            We encountered an error while trying to manage the banners. This could be due to network issues or insufficient permissions.
          </p>
