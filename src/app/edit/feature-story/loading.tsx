export default function EditFeatureStoryLoading() {
  return (
    <div className="min-h-screen py-12 bg-gray-100">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="space-y-6">
          {/* Generate 3 story card skeletons */}
          {[...Array(3)].map((_, index) => (
            <div key={index} className="p-6 rounded-lg shadow-md bg-white">
              ...
              <div className="mb-4">
                <div className="h-48 bg-gray-200 rounded w-full animate-pulse" />
              </div>
