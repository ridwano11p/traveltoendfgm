...
export default function EditBlogError({ error, reset }: ErrorProps) {
      ...
      <div className="max-w-xl mx-auto px-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            We encountered an error while trying to manage the blog posts. This could be due to network issues, file size limits, or insufficient permissions.
          </p>
